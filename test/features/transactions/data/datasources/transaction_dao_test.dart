...
void main() {
  ...
  group('TransactionDao', () {
    ...
    test(
      'insertTransaction should insert a transaction and return its id',
      () async {
        // act
    ...
    test(
      'updateSyncStatus should update the sync status of a transaction',
      () async {
        // arrange
        ...
        )..where((tbl) => tbl.id.equals(tTransactionDb.id))).getSingle();
