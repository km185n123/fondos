...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Fund&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.minimumAmount, minimumAmount) || other.minimumAmount == minimumAmount)&&(identical(other.category, category) || other.category == category));
}
...
@override
String toString() {
  return 'Fund(id: $id, name: $name, minimumAmount: $minimumAmount, category: $category)';
}
...
class _Fund extends Fund {
  const _Fund({required this.id, required this.name, required this.minimumAmount, required this.category}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Fund&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.minimumAmount, minimumAmount) || other.minimumAmount == minimumAmount)&&(identical(other.category, category) || other.category == category));
}
