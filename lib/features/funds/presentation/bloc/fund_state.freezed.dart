...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FundState);
}
...
/// @nodoc
class $FundStateCopyWith<$Res>  {
$FundStateCopyWith(FundState _, $Res Function(FundState) __);
}


/// Adds pattern-matching-related methods to [FundState].
extension FundStatePatterns on FundState {
...
class _Initial implements FundState {
  const _Initial();
...
class _Loading implements FundState {
  const _Loading();
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $FundStateCopyWith<$Res> {
...
class _Error implements FundState {
...
@override
String toString() {
  return 'FundState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $FundStateCopyWith<$Res> {
